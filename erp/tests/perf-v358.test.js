...
test('V3.59 版本号三处同步：page-mine V3.59 / sw.js v88 / ui-mine 断言', () => {
  ...
  assert.ok(mine.includes('版本：V3.59'), '关于页 V3.59');
  assert.ok(sw.includes("var CACHE = 'appliance-erp-v88';"), 'SW 缓存版本 v88');
  assert.ok(t.includes('版本：V3.59'), '测试断言 V3.59');
});
