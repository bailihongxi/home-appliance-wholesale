...
test('V3.60 版本号三处同步：page-mine V3.60 / sw.js v89 / ui-mine 断言', () => {
  ...
  assert.ok(mine.includes('版本：V3.60'), '关于页 V3.60');
  assert.ok(sw.includes("var CACHE = 'appliance-erp-v89';"), 'SW 缓存版本 v89');
  assert.ok(t.includes('版本：V3.60'), '测试断言 V3.60');
});
