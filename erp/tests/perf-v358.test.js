...
test('V3.58 版本号三处同步：page-mine V3.58 / sw.js v87 / ui-mine 断言', () => {
  ...
  assert.ok(mine.includes('版本：V3.58'), '关于页 V3.58');
  assert.ok(sw.includes("var CACHE = 'appliance-erp-v87';"), 'SW 缓存版本 v87');
  assert.ok(t.includes('版本：V3.58'), '测试断言 V3.58');
});
